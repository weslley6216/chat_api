...
describe 'Conversations API', type: :request do
  ...
  describe 'POST /conversations' do
    ...
    it 'creates a new conversation' do
      post conversations_path, params: { conversation: conversation_params }
    ...
    it 'returns error if parameters are invalid' do
      post conversations_path, params: { conversation: { user_a_id: nil, user_b_id: nil } }
